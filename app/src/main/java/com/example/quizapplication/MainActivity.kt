            ...
            question.options.forEach { option ->
                Row(
                    ...
                    modifier = Modifier
                        .fillMaxWidth()
                        .padding(8.dp)
                        //TODO nag add ko og selectable instead sa radio button amg trigger imong answeredSelected para kng mag trigger sya sa text ma apil og select
                        .selectable(
                            selected = selectedAnswer == option, onClick = {
                    ...
                    RadioButton(
                        selected = selectedAnswer == option, onClick = null
                    )

                    Spacer(modifier = Modifier.width(8.dp))

                    Text(
                        option, modifier = Modifier.padding(10.dp)
                    )
                }
            }
        }
